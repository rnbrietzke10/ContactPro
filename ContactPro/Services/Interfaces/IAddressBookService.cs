...
namespace ContactPro.Services.Interfaces
{
	...
	{
		Task AddContactToCategoryAsync(int catgoryId, int contactId);
		Task<bool> IsContactInCategory(int catgoryId, int contactId);
		...
		Task RemoveContactFromCategoryAsync(int catgoryId, int contactId);
